...
const Form = ({ title, fields, buttonText, onSubmit, footerContent, backgroundColor, formClassName }) => {
    ...
    return (
        ...
        >
            ...
            {fields.map((field, index) => (
                <div className={`container_inputs ${fields[index].className || ''}`} key={index}>
